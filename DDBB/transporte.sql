...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-06-2019 a las 04:11:59
...
INSERT INTO `bus` (`placa`, `asiento`, `calefaccion`, `busescol`) VALUES
('A5S-111', 72, 'no', NULL),
('AE3-999', 67, 'no', NULL),
('AQC-129', 67, 'no', NULL),
('AQV-256', 72, 'no', NULL),
...
INSERT INTO `conductor` (`dniconductor`, `licencia`, `categoria`, `nombre`, `experiencia`) VALUES
...
INSERT INTO `menu` (`idmenu`, `desmenu`) VALUES
('m1', 'archivo'),
('m2', 'venta'),
('m3', 'reporte');
...
INSERT INTO `pasajero` (`dnipasajero`, `nombre`, `direccion`, `celular`, `fecha nacimiento`) VALUES
(40526929, 'Puma Ancco Juan Carlos', 'Ica', '912245748', '1991-06-03'),
(41468174, 'Delgado Callohuanca Manuel Antonio', 'San Martin', '974218716', '1980-06-11'),
(41747900, 'Apaza Choque Alex Ruben', 'Huanuco', '920536962', '2001-07-10'),
(43288217, 'Mamani Zapana Eduardo Jack', 'Pasco', '958442609', '1994-06-10'),
(43577550, 'Calsina Mamani Nery Maribel', 'Ancash', '975057593', '2001-12-10'),
(46025196, 'Alzamora Venegas Cesar Augusto', 'Arequipa', '975468678', '1980-06-07'),
(46194620, 'Huaycani Copaja Edy Walter', 'Piura', '938507398', '1994-09-03'),
(46308742, 'Pocohuanca Pari Rocio Carmen', 'Cajamarca', '987033811', '2001-06-04'),
(46685048, 'Lopez Saavedra Jean Elvis', 'Ayacucho', '921901842', '1992-06-07'),
(46760516, 'Machaca Condori Noe', 'La Libertad', '960729350', '1997-05-06'),
(47647066, 'Quispe Cornejo Juan Elvis', 'Tacna', '913405686', '1990-12-02'),
(47724131, 'Gallegos Pineda Albert David', 'Cajamarca', '927451762', '1993-11-07'),
(47769812, 'Itusaca Anahua Walter Jhonny', 'Ancash', '952556423', '1980-05-03'),
(47870248, 'Cori Choque Abraham', 'La Libertad', '993373271', '1986-01-12'),
(61698807, 'Mendoza Roque Diana Aransha', 'Amazonas', '943134355', '1996-05-09'),
(62627913, 'Torres Benavides Carlos Mauricio', 'Lambayeque', '984894948', '1989-01-10'),
(70002054, 'Mendo Belizario Lidia Nancy', 'Ucayali', '932342570', '1983-01-09'),
(70003417, 'Mestas Apaza Jean Marco', 'Tacna', '931693831', '1997-03-11'),
(70003852, 'Chura Palomino Set Handrews', 'Loreto', '981909657', '1982-05-06'),
(70041495, 'NuÑEz Amanqui Mercy Danitza', 'Loreto', '937373261', '1999-11-01'),
(70047447, 'Apaza Velasquez Erika Yuliana', 'Ica', '946252011', '2002-08-12'),
(70050806, 'Huisa Ari Jennifer Tania', 'Tumbes', '983219558', '1998-10-06'),
(70054356, 'Bernedo Melo Mashiel Jenny', 'Ica', '914597825', '1993-10-05'),
(70063469, 'Vargas Machaca Liz Eufemia', 'Cuzco', '918338070', '1990-10-04'),
(70074434, 'Choque Arias Christian', 'Ucayali', '971105898', '1990-09-09'),
...
CREATE TABLE `submenu` (
  ...
  `menu_idmenu` varchar(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `submenu` (`idsubmenu`, `dessubmenu`, `menu_idmenu`) VALUES
('sm1', 'pasajero', 'm1'),
('sm2', 'bus', 'm1'),
('sm3', 'conductor', 'm1');
...
INSERT INTO `usuario` (`idusuarios`, `nombre`, `login`, `clave`) VALUES
(1, 'Administrador', 'admin', '63a9f0ea7bb98050796b649e85481845'),
(2, 'Arnaldo Medina', 'medina', 'aa4f56f555e2f3b4d4705ea05c12028c'),
(3, 'Diego Romani', 'diego569', '9987137f2b18749bfa2fa2f97cc6c458'),
(4, 'Jhon Quispe', 'jhon', '81dc9bdb52d04dc20036dbd8313ed055'),
(5, 'Fredy Cahuana', 'fredy', 'b5a7bbf2ecd5953e6640d675849deca9'),
(6, 'Cristian Velez', 'cristianvelez', '3f7d2a56f5b27b6391fb11a4c5301131'),
(7, 'Luis Miguel Rojas', 'luis', '827ccb0eea8a706c4c34a16891f84e7b');
...
CREATE TABLE `viaje` (
  `conductor_dniconductor` varchar(8) NOT NULL,
...
--
ALTER TABLE `boleto`
  ADD PRIMARY KEY (`idBoleta`,`pasajeros_dni`,`usuarios_idusuarios`),
  ADD KEY `fk_Boleto_pasajeros1_idx` (`pasajeros_dni`),
  ADD KEY `fk_Boleto_usuarios1_idx` (`usuarios_idusuarios`);
...
--
ALTER TABLE `submenu`
  ADD KEY `fk_submenu_menu1_idx` (`menu_idmenu`);
...
--
ALTER TABLE `viaje`
  ADD PRIMARY KEY (`conductor_dniconductor`,`bus_placa`),
  ADD KEY `fk_conductor_has_bus_bus1_idx` (`bus_placa`),
  ADD KEY `fk_conductor_has_bus_conductor1_idx` (`conductor_dniconductor`);
...
--
ALTER TABLE `boleto`
  ADD CONSTRAINT `fk_Boleto_pasajeros1` FOREIGN KEY (`pasajeros_dni`) REFERENCES `pasajero` (`dnipasajero`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Boleto_usuarios1` FOREIGN KEY (`usuarios_idusuarios`) REFERENCES `usuario` (`idusuarios`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `submenu`
--
ALTER TABLE `submenu`
  ADD CONSTRAINT `fk_submenu_menu1` FOREIGN KEY (`menu_idmenu`) REFERENCES `menu` (`idmenu`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `viaje`
--
ALTER TABLE `viaje`
  ADD CONSTRAINT `fk_conductor_has_bus_bus1` FOREIGN KEY (`bus_placa`) REFERENCES `bus` (`placa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_conductor_has_bus_conductor1` FOREIGN KEY (`conductor_dniconductor`) REFERENCES `conductor` (`dniconductor`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
